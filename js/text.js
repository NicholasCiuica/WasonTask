const optionText = {
  options: [
...

    {
      ...
      infoText: `The “beer” task shown above is an example of a “deontic” task because its contents are related to social/ethical rules (the legal drinking age in the US at the time of the experiment was 19, but I changed it here to reflect modern laws). Griggs and Cox also created this task (1982) and found that participants performed significantly better on this task than their abstract control task or their previous everyday task. Indeed, participants of deontic tasks make the correct selection 69% of the time (Ragni, n.d.). This result and other research suggests that human brains may have evolved a cheater-detection mechanism that allows for increased performance in social “detective” roles (Van Lier et al., 2013). While the brain uses heuristics and biases to simplify abstract and everyday tasks, it may have evolved this innate cheater-detection to find unfairness or rule-breaking in social situations because cooperation is better for group survival.`,
      sources: [
        `Griggs, R. A., & Cox, J. R. (1982). The elusive thematic-materials effect in Wason’s selection task. British Journal of Psychology, 73, 407-420. http://cogsci.bme.hu/~ktkuser/KURZUSOK/BMETE47MN05/2017_2018_2/Griggs_Cox_1982_The-elusive-thematic-materials-effect-in-Wasons-selection-task.pdf`,
        `Ragni, M. (n.d.). The Wason Selection Task: A Meta-Analysis. https://escholarship.org/content/qt3rv0k45d/qt3rv0k45d_noSplash_8646c09c2d9744d4cabdbda295edd889.pdf?t=sgiit1`,
